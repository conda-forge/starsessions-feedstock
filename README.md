...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/starsessions-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14051&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/starsessions-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `starsessions` can be installed with:

```
conda install starsessions
```

It is possible to list all of the versions of `starsessions` available on your platform with:
